...
import { FiSend, FiUserPlus, FiMessageCircle, FiSmartphone, FiShield, FiUser } from "react-icons/fi";
    ...
    <div className="bg-white text-black">
      ...
      <section className="min-h-[90vh] flex flex-col-reverse lg:flex-row items-center justify-between px-6 lg:px-20 py-10">
        <div className="lg:w-1/2 text-center lg:text-left">
          ...
          <p className="text-lg text-gray-700 mb-4">
            Real-time chatting made simple. Stay connected, share moments, and collaborate—wherever you are.
          </p>
          <Link
        ...
        <div className="lg:w-1/2 mb-10 lg:mb-0">
          <img src="/heropic.png" alt="Hero" className="w-full max-w-xl mx-auto" />
        </div>
      </section>
      ...
      <section className="py-16 px-6 lg:px-20 bg-white text-center">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {["Fast and reliable", "Beautiful UI", "Great for teams"].map((msg, idx) => (
            <div key={idx} className="bg-gray-100 p-6 rounded-md border">
              <p className="italic text-gray-600 mb-2">“{msg}.”</p>
              <div className="flex items-center justify-center gap-2 mt-3 text-sm font-medium text-primary">
      ...
      <section className="py-16 px-6 lg:px-20 bg-primary text-white text-center">
        ...
        <p className="mb-6 text-lg">It’s free, fast, and fun to use. What are you waiting for?</p>
        <Link
          to={isLogin ? "/chat" : "/signup"}
