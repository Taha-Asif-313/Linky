    ...
    <div className="h-[600px] flex lg:justify-between justify-center items-center md:h-screen max-lg:py-20 max-lg:h-auto px-8 md:flex-row flex-col-reverse ">
      <div className=" mx-auto max-md:text-center lg:pl-10 md:w-[50%]">
        ...
        <p className="text-base mt-4 lg:pr-20">
          A real-time chat app built with Firebase and React, enabling seamless
          one-on-one messaging. It features authentication, real-time updates,
          and a user-friendly interface for instant communication across
          devices.
        </p>
        <div className="flex max-sm:flex-col justify-start gap-6 mt-4">
          ...
          >
            {isLogin ? "Go to  chat" : "Lets Discover"}
          </Link>
        </div>
      </div>
